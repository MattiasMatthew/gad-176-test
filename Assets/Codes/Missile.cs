...
{
    [SerializeField] protected Transform target;    // Target to follow (MainCharacter)
    [SerializeField] protected float speed = 5f;    // Speed of the missile
    [SerializeField] protected float rotateSpeed = 200f;    // Rotation speed of the missile
    [SerializeField] protected GameObject Kaboom;    // Explosion prefab

    protected Rigidbody2D rb;    // Rigidbody component of the missile
